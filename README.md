...
There is also a folder called "images" that contains images of the MH-65 (pictured at the top of this document) and the MH-60 (pictured at the bottom of this document), as well as images from QGIS used in the "Results" section. 
...
### Conclusion
In conclusion, the U.S. Coast Guard's shift from a mixed helicopter fleet to a single helicopter fleet of MH-60s is very beneficial to residents and mariners. The total coverage area and overlapping coverage from two air stations increases as this change occurs, increasing SAR capabilities for maritime response. 
